  ...
  `;
    ...
    return (
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 space-y-4">
            <h3 className="font-semibold text-gray-800 text-lg mb-2">Məlumatlar</h3>

            <div>
                <label className="text-sm font-medium text-gray-700 mb-1 block">Yoxlayan Şəxs (İnspektor)</label>
                <input
                    type="text"
                ...
                {isRequiredEmpty(value.inspector_name) && (
                    <p className="text-red-500 text-xs mt-1">Bu sahə mütləqdir</p>
                )}
            </div>

            <div>
                <label className="text-sm font-medium text-gray-700 mb-1 block">İş Yeri / Obyekt</label>
                <input
                    type="text"
                    ...
                    placeholder="İşin görüləcəyi yer"
                />
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label className="text-sm font-medium text-gray-700 mb-1 block">Şirkət (opsional)</label>
                    <input
                        type="text"
            ...
            <div>
                <label className="text-sm font-medium text-gray-700 mb-1 block">Əlavə Qeydlər (opsional)</label>
                <textarea
                    value={value.notes}
                    ...
                    placeholder="Buraya əlavə etmək istədiyiniz detalları yazın..."
                />
            </div>
        </div>
    );
